...
class TotalProcessAudit:
    def __init__(self):
        ...
        self.url_categories = {
            "年度计划": "http://sjt.gxzf.gov.cn/zwgk/fdzdgknr/gzghjjz/ndjh/",
            "中长期规划": "http://sjt.gxzf.gov.cn/zwgk/fdzdgknr/gzghjjz/zcqgh/",
            "自治区政策文件": "http://sjt.gxzf.gov.cn/zwgk/fdzdgknr/zcfg/zzqzcff/",
            "政策文件解读": "http://sjt.gxzf.gov.cn/zwgk/fdzdgknr/zcwjjd/",
            "建议提案": "http://sjt.gxzf.gov.cn/zwgk/fdzdgknr/JYTA_01/",
            "通知": "http://sjt.gxzf.gov.cn/zwgk/fdzdgknr/zcfg/sjtwj/tz/",
            "通报": "http://sjt.gxzf.gov.cn/zwgk/fdzdgknr/zcfg/sjtwj/tb/",
            "报告": "http://sjt.gxzf.gov.cn/zwgk/fdzdgknr/zcfg/sjtwj/bg/",
            "其他文件": "http://sjt.gxzf.gov.cn/zwgk/fdzdgknr/zcfg/sjtwj/qtwj/",
            "函": "http://sjt.gxzf.gov.cn/zwgk/fdzdgknr/zcfg/sjtwj/h/",
    ...
    def get_title_urls(self, base_url):
        ...
        if not title_soup:
            title_soup = soup.find('ul', attrs={"class": "zfxxgk-more-list"})
