...
def sql_server_info(targetSource="服务器"):
    ...
    if targetSource == "自己":
        ...
        # DRIVER={SQL Server};SERVER=SC-201704181448\\SQLEXPRESS;DATABASE=[cnlaw1.0];UID=sa;PWD=123qwe!@#
        # connInfo = 'DRIVER={SQL Server};SERVER=192.168.31.124\SQLEXPRESS;DATABASE=自收录数据;UID=sa;PWD=123qwe!@#'
        connInfo = 'DRIVER={SQL Server};SERVER=47.97.3.24,14333;DATABASE=FB6.0;UID=saa;PWD=99xZZPBpmceAzpuL^AHuhVome50iglKP%e*2V!RJY$To3VR15#1NT#JhoNgROjO3'
        # connInfo = 'DRIVER={SQL Server};SERVER=SC-201704181448\SQLEXPRESS;DATABASE=自收录数据;UID=sa;PWD=123qwe!@#'
    elif targetSource == "法宝5.0":
        # DRIVER={SQL Server};SERVER=SC-201704181448\\SQLEXPRESS;DATABASE=[cnlaw1.0];UID=sa;PWD=123qwe!@#
        # connInfo = 'DRIVER={SQL Server};SERVER=192.168.31.124\SQLEXPRESS;DATABASE=自收录数据;UID=sa;PWD=123qwe!@#'
        connInfo = 'DRIVER={SQL Server};SERVER=47.97.3.24,14333;DATABASE=FddLaw5.0;UID=saa;PWD=99xZZPBpmceAzpuL^AHuhVome50iglKP%e*2V!RJY$To3VR15#1NT#JhoNgROjO3'
        # connInfo = 'DRIVER={SQL Server};SERVER=SC-201704181448\SQLEXPRESS;DATABASE=自收录数据;UID=sa;PWD=123qwe!@#'
    elif targetSource == "157":
        # DRIVER={SQL Server};SERVER=SC-201704181448\\SQLEXPRESS;DATABASE=[cnlaw1.0];UID=sa;PWD=123qwe!@#
        connInfo = 'DRIVER={SQL Server};SERVER=192.168.31.157;DATABASE=新版数据左菜单;UID=sa;PWD=123qwe!@#'
...
def 登录cookie使用(conn_info,sql):
    conn_cur = get_connect_cursor(conn_info)
    conn = conn_cur[0]
    cursor = conn_cur[1]
    # conn = 'DRIVER={SQL Server};SERVER=47.97.3.24,14333;DATABASE=自收录数据;UID=saa;PWD=99xZZPBpmceAzpuL^AHuhVome50iglKP%e*2V!RJY$To3VR15#1NT#JhoNgROjO3'
    # cursor = conn.cursor()
    # 执行sql语句
    # sql = 'select * from dffg '
    # insertsql="INSERT INTO dffg(title,full,url,date) VALUES ('asdawwa','afawdawwwwwwwwwwwsaa','asdadw','2020-08-19')"
